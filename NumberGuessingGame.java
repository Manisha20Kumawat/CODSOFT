...
public class NumberGuessingGame extends JFrame implements ActionListener {
    ...
    private int score; // Moved score declaration here
    ...
    public NumberGuessingGame() {
        ...
        add(guessField);
        add(guessButton);
        add(new JScrollPane(feedbackArea)); // Added JScrollPane for feedbackArea
        add(playAgainButton);

        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        pack(); // Automatically sizes the frame based on its components
        setVisible(true);
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(NumberGuessingGame::new); // Using invokeLater to ensure Swing components are initialized on the Event Dispatch Thread
    }
}
